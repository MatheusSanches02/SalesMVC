...
namespace SalesMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any()) //Any, verifica se existe objetos ja criados em cada classe
            {
            ...
            //Department d4 = new Department{Id = 4, Name = "Books"}; --> modo alternativo de criar objetos
